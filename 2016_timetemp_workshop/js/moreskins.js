CoolClock.config.skins = {
	...
	tempskin: {
		outerBorder:      { lineWidth: 2, radius: 90, color: "BurlyWood", alpha: 1 },
		smallIndicator:   { lineWidth: .5, startAt: 78, endAt: 88, color: "DarkGoldenRod", alpha: 1 },
		largeIndicator:   { lineWidth: 1, startAt: 70, endAt: 90, color: "Chocolate", alpha: 1 },
		hourHand:         { lineWidth: 8, startAt: -15, endAt: 50, color: "CornflowerBlue", alpha: 1 },
		minuteHand:       { lineWidth: 7, startAt: -15, endAt: 75, color: "CornflowerBlue", alpha: 1 },
		secondHand:       { lineWidth: 1, startAt: -20, endAt: 85, color: "DarkBlue", alpha: 1 },
	},
